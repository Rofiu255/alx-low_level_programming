...
/**
 * iter_zeroes - Iterates through a string of numbers containing
...
/**
 * find_mul - Multiplies a string of numbers by a single digit.
...
/**
 * sum_nums - Adds the numbers stored in two strings.
...
int main(int argc, char *argv[])
{
	...
	if (*(argv[1]) == '0')
		argv[1] = iter_zeroes(argv[1]);
	if (*(argv[2]) == '0')
		argv[2] = iter_zeroes(argv[2]);
	...
	for (i = get_strlen(argv[2]) - 1; i >= 0; i--)
	{
		...
		sum_nums(final_prod, next_prod, size - 1);
	}
